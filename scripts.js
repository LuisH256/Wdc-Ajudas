...
Devolução recebida por meio da NF nº ......., emitida em ....../....../........
    ...
    function resetFields() {
        // Limpa todos os campos e oculta as seções
        ...
        eanInput.value = '';
        swqtInput.value = '';
        emailContent.textContent = ''; // Limpa o conteúdo do e-mail
        emailPreview.classList.add('hidden'); // Esconde pré-visualização
    ...
    emailTemplate.addEventListener('change', () => {
        resetFields(); // Reseta os campos ao trocar de template
