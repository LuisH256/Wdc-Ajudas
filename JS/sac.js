    ...
    const templateMap = {
        ...
        'sac-template': {
            ...
            devolucao_rma: () => { 
                setVisibility(elements.destinatario_container, true); 
                setVisibility(elements.tipo_operacao_container, true); 
                setVisibility(elements.rma_fields, true); // Exibe CRG
                setVisibility(elements.solar_options, true); // Pai dos campos
                
                // ESCONDER campos solicitados conforme imagem
                ...
                if(elements.descricao_input) setVisibility(elements.descricao_input.closest('.mb-3') || elements.descricao_input.parentElement, false); // REMOVIDO conforme imagem
                
                // GARANTIR visibilidade dos campos que devem continuar (CRG e Quantidade)
